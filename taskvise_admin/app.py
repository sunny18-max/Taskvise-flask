...
def login():
    ...
    if request.method == 'POST':
        ...
        return render_template(
            ...
            founder_email=admin_manager.FOUNDER_EMAIL,
            founder_password=admin_manager.FOUNDER_PASSWORD,
        )
...
def dashboard():
    return render_template(
        'dashboard.html',
        founder_name=session.get('full_name', 'TaskVise Founder'),
        founder_email=session.get('username', admin_manager.FOUNDER_EMAIL),
    )
